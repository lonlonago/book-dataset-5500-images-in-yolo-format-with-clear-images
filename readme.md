# Book dataset (5500 images in YOLO format with clear images

# Body

Book dataset, 5500 images in YOLO format, clear images, complete annotations, suitable for target detection model training, ready to use, saves time and effort.
